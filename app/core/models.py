...
from sqlalchemy import INTEGER, DateTime, MetaData, String, UniqueConstraint
from sqlalchemy.orm import DeclarativeBase, Mapped, mapped_column
from sqlalchemy.sql import func

from app.settings import settings

base_metadata = MetaData(schema=settings.DB_SCHEMA)
...
class ExampleText(Base):
    ...
    __table_args__ = (UniqueConstraint("entity_id", "entity_date", name="text_constraint"),)
